         ...
         bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            ...
            <div>
                ...
                <div className="mt-8 text-center">
                    {/* Next/Image */}
                    <Image src="https://tailus.io/sources/blocks/stats-cards/preview/images/second_user.webp" alt="lindis" width={30} height={30} className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28" />
